...
if not DB_PATH.exists():
	...
	item_file_1 = models.ItemFile(filename='test_file_1.txt', data=file_data_1,
									creation_time=datetime.utcnow(), modification_time=datetime.utcnow(),
									author=file_author, file_description='This is a test file to download', file_type='doc')
	item_file_2 = models.ItemFile(filename='test_file_2.txt', data=file_data_2,
									creation_time=datetime.utcnow(), modification_time=datetime.utcnow(),
									author=file_author, file_description='This is an another test file to download', file_type='doc')
